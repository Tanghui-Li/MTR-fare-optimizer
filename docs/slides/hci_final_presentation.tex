...
\begin{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.48\textwidth}
      ...
      欢迎课后访问和试用。\\[0.6em]
      \qrcode[height=1.75cm]{https://mtr-optimizer.shgao.top}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{桌面端信息架构：规划与地图并列}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.58\textwidth}
      \includegraphics[width=\linewidth,height=0.66\textheight,keepaspectratio]{desktop-map-overview.png}
    \end{column}
...
\begin{frame}{路线结果展示：让用户敢按推荐走}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.50\textwidth}
      \includegraphics[width=\linewidth,height=0.70\textheight,keepaspectratio]{route-result-desktop.png}
    \end{column}
  \end{columns}
...
\begin{frame}{移动端适配：地图优先与底部面板}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.27\textwidth}
      \includegraphics[width=\linewidth,height=0.68\textheight,keepaspectratio]{mobile-overview.png}
    \end{column}
    \begin{column}{0.27\textwidth}
      \includegraphics[width=\linewidth,height=0.68\textheight,keepaspectratio]{mobile-narrow.png}
    \end{column}
